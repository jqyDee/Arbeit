...
pdf.write(6.5, ""+Kürzel+"                                                     "+Rechnungsnummer+"                                            "+AktuellesDatum)
...
pdf.set_font("Arial", "", 12)
pdf.cell(0, 6, "", ln=1, align="C")
pdf.write(6.5, "Ich bitte Sie, den Gesamtbetrag von "+str(gesamtPreis)+" Euro innerhalb von 14 Tagen unter Angabe der Rechnungsnummer auf unten stehendes Konto zu überweisen.")
...
while Platzhalter != "n" and Platzhalter != "y":
    ...
    if Platzhalter == "y":
        #PDF Speichern
        pdf.ln(100)
        pdf.output("E:\\KGRechnungsprogramm\\Rechnungen\\Rechnungen\\Rechnungen2020\\"+Rechnungsnummer+".pdf")

        #______________________________________________________________________________________________________
        #Speichern der Daten in die TXT Datei
        insgKilometer = 2*KilometerZuFahren*intBehandlungstermine
        os.path.isfile("E:\\KGRechnungsprogramm\Rechnungen\\ZusammenfassungRechnungen\\RechnungenInsgesamt2020.txt")
        my_file = Path("E:\\KGRechnungsprogramm\Rechnungen\\ZusammenfassungRechnungen\\RechnungenInsgesamt2020.txt")
        if my_file.exists():
            DateiMitKurzel = open("E:\\KGRechnungsprogramm\\Rechnungen\\ZusammenfassungRechnungen\\RechnungenInsgesamt2020.txt", "a")
            DateiMitKurzel.write("\n"+str(Kürzel)+";"+str(Rechnungsnummer)+";"+str(KilometerZuFahren)+";km;"+str(insgKilometer)+";km;"+str(gesamtPreis)+";Euro;"+u1+";"+u2+";"+u3+";"+u4+";"+u5+";"+u6+";"+u7+";"+u8+";"+u9+";"+u10+";")
        else:
            DateiMitKurzel = open("E:\\KGRechnungsprogramm\\Rechnungen\\ZusammenfassungRechnungen\\RechnungenInsgesamt2020.txt", "w")
            DateiMitKurzel.write("\n"+str(Kürzel)+";"+str(Rechnungsnummer)+";"+str(KilometerZuFahren)+";km;"+str(insgKilometer)+";km;"+str(gesamtPreis)+";Euro;"+u1+";"+u2+";"+u3+";"+u4+";"+u5+";"+u6+";"+u7+";"+u8+";"+u9+";"+u10+";")
